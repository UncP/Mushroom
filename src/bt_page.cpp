...
void BTreePage::Split(BTreePage *that, const uint8_t key_len)
{
	uint16_t start = total_key_ >> 1;
...
BTreePage* BTreePager::NewPage()
{
	BTreePage *page = BTreePage::NewPage(curr_);
	if (page) {

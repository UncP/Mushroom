...
{
	uint16_t left = total_key_ >> 1, index = left, right = total_key_ - left;
...
BTreePage* BTreePage::NewPage(const page_id page_no, int type, uint8_t key_len, uint8_t level)
{
